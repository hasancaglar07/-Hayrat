...
export function LandingNav({ locale, t }: { locale: Locale; t: Messages }) {
        ...
        <div className="nav-section grid h-[72px] grid-cols-[auto_1fr_auto] items-center gap-x-3 sm:h-[84px] sm:gap-x-4 md:grid-cols-[1fr_auto_1fr]">
          ...
          <div className="col-start-3 flex items-center justify-end gap-2 md:justify-self-end">
            ...
            <div className="flex items-center gap-2 md:hidden">
              <Link
                className="inline-flex h-10 items-center justify-center rounded-lg bg-gradient-to-r from-primary to-teal-500 px-4 text-base font-semibold text-white shadow-soft ring-1 ring-white/10 transition-colors hover:brightness-105"
                href={`/${locale}/app`}
              >
                {t.landing.ctaOpen}
              </Link>
              <button
                ...
                className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-white/60 text-text-dark shadow-soft ring-1 ring-border-light/70 backdrop-blur transition-colors hover:bg-white dark:bg-background-offwhite/60 dark:text-white dark:ring-white/10 dark:hover:bg-background-offwhite"
              >
